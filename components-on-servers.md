...
```shell 
$ sudo su - student 
student> wget -qO- https://archive.apache.org/dist/tomcat/tomcat-8/v8.5.45/bin/apache-tomcat-8.5.45.tar.gz | tar -xz 
student> cd apache-tomcat-8.5.45
```
...
```shell 
student> /home/student/apache-tomcat-8.5.45/bin/startup.sh 
```
